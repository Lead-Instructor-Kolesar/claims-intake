...
- measured reason: highest required_evidence_recall (69/72), then citation_correctness (73/73), then unsupported_field_avoidance (8/12); no generation failures
- rejected alternative(s): qwen/extract.v2 (transfer) (60/72, 2 failed)
...
- measured reason: highest required_evidence_recall (59/60), then citation_correctness (60/63), then unsupported_field_avoidance (8/12); no generation failures
- rejected alternative(s): qwen/summarize.v1 (transfer) (55/60, 1 failed)
- reopen when: a newer prompt version or model changes measured quality, latency, or boundary/PII outcomes on this 12-case corpus
